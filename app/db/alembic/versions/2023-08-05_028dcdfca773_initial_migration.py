...
Revision ID: 028dcdfca773
Revises: 
Create Date: 2023-08-05 14:57:12.434802
...
def upgrade() -> None:
    ...
    sa.Column('status', postgresql.ENUM('IN_PROCESS', 'FINISHED', name='trainingstatusenum'), nullable=False),
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('dt_created', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('dt_updated', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    ...
    sa.Column('team_id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['team_id'], ['teams.id'], name=op.f('fk__user_teams__team_id__teams')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk__user_teams__user_id__users')),
